package com.dppm.patient.common;

import com.dppm.patient.constants.PatientConstants;
...
import static com.dppm.patient.constants.PatientConstants.DATE_FORMAT_VIEW;
import static com.dppm.patient.constants.PatientConstants.DATE_ONLY_FORMAT_VIEW;
...
public class Common {
    ...
    private static final DateTimeFormatter ID_DATE_FORMATTER = DateTimeFormatter.ofPattern(
            PatientConstants.DATE_TIME_FORMATTER_ID_CREATION
    );
